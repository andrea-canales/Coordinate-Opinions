...
\end{equation}
For each $C\subseteq V$, the limit opinion is a function of the intrinsic opinions $\gamma_0$ and $\beta$ and it will be useful in what follows to consider the function mapping a pair $(\gamma_0,\beta)\in [0,1]^V\times [0,1]$ onto $\Omega_C(\gamma_0,\beta)=\alpha_C \gamma_0^{\beta}\in \RR^V$.\\
